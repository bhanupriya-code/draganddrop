...
const CreateTask = ({tasks, setTasks}) => {
    ...
    return(
        <form onSubmit={submitHandler}>
           <input type="text" onChange={(e) => setTask({...task, id: uuidv4(), name: e.target.value})} value={task.name}  className="border-2 border-slate-400 bg-slate-100 rounded-md mr-4 h-12 w-64 px-1" />
